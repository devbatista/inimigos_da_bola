...
- Mobile: telas de login, convite (aceitar via deep link com seleção de `player_type`, `casual` pré-selecionado), desbloqueio por biometria após primeiro acesso, perfil próprio
